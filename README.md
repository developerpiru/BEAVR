...
**Bug:** | **Fix:**
---------|---------
PCA plot, gene read count plot, and volcano plot won't auto-update after changing the treatment condition. The results table will update correctly. | Just refresh the page and change the treatment condition.
